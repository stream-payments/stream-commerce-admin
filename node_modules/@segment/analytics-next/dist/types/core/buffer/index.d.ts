 ...
 */
export declare type PreInitMethodName = 'screen' | 'register' | 'deregister' | 'user' | 'trackSubmit' | 'trackClick' | 'trackLink' | 'trackForm' | 'pageview' | 'identify' | 'reset' | 'group' | 'track' | 'ready' | 'alias' | 'debug' | 'page' | 'once' | 'off' | 'on' | 'addSourceMiddleware' | 'setAnonymousId' | 'addDestinationMiddleware';
...
export declare type PreInitMethodParams<MethodName extends PreInitMethodName> = Parameters<Analytics[MethodName]>;
/**
...
export declare type AnalyticsLoader = (preInitBuffer: PreInitMethodCallBuffer) => Promise<[Analytics, Context]>;
